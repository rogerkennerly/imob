<?php 
  ...
  // $imobiliaria_controle[1]['cliente']   = 'imob.hospedaria.com.br';
  // $imobiliaria_controle[1]['diretorio'] = 'gomesimoveisjau.com.br';
  // $imobiliaria_controle[1]['userdb']    = 'rodrgus291r';
  // $imobiliaria_controle[1]['passdb']    = '92Kfs251Gee1';
  // $imobiliaria_controle[1]['basedb']    = 'rodriguesimoveisjau_com_br_1';
  
  $imobiliaria_controle[2]['cliente']   = 'jmimovel.com.br';
  $imobiliaria_controle[2]['diretorio'] = 'jmimovel';
  $imobiliaria_controle[2]['userdb']    = 'jmusr361';
  $imobiliaria_controle[2]['passdb']    = 'jmp02ss59k';
  $imobiliaria_controle[2]['basedb']    = 'jmimovel_com_br_1';
  
  $imobiliaria_controle[3]['cliente']   = 'site.casajau.com.br';
  $imobiliaria_controle[3]['diretorio'] = 'casajau';
  $imobiliaria_controle[3]['userdb']    = 'sitecasauser';
  $imobiliaria_controle[3]['passdb']    = 'sitecasapass';
  $imobiliaria_controle[3]['basedb']    = 'site_casajau_com_br_1';
  
  $imobiliaria_controle[4]['cliente']   = 'regionalbarrabonita.com.br';
  $imobiliaria_controle[4]['diretorio'] = 'regionalnegocios';
  $imobiliaria_controle[4]['userdb']    = 'regnegocios001';
  $imobiliaria_controle[4]['passdb']    = 'regionalpass002';
  $imobiliaria_controle[4]['basedb']    = 'regionalnegocios_com_br_1';
  ...
  $imobiliaria_controle[14]['cliente']   = 'dinamicaimobiliaria.com';
  $imobiliaria_controle[14]['diretorio'] = 'dinamicaimobiliaria';
  $imobiliaria_controle[14]['userdb']    = 'dn72us6r';
  $imobiliaria_controle[14]['passdb']    = 'Fas220hq48';
  $imobiliaria_controle[14]['basedb']    = 'dinamicaimobiliaria_com_1';
	
  $imobiliaria_controle[15]['cliente']   = 'gagimoveisjau.com.br';
  $imobiliaria_controle[15]['diretorio'] = 'gagimoveisjau.com.br';
  $imobiliaria_controle[15]['userdb']    = 'uf31sfm1';
  $imobiliaria_controle[15]['passdb']    = 'D2fk2ll108Fs';
  $imobiliaria_controle[15]['basedb']    = 'gagimoveisjau_com_br_1';
	
  $imobiliaria_controle[16]['cliente']   = 'gomesimoveisjau.com.br';
  $imobiliaria_controle[16]['diretorio'] = 'gomesimoveisjau.com.br';
  $imobiliaria_controle[16]['userdb']    = 'rodrgus291r';
  $imobiliaria_controle[16]['passdb']    = '92Kfs251Gee1';
  $imobiliaria_controle[16]['basedb']    = 'rodriguesimoveisjau_com_br_1';
	
  $imobiliaria_controle[17]['cliente']   = 'urbe.tietenegocios.com.br';
  $imobiliaria_controle[17]['diretorio'] = 'urbe.tietenegocios.com.br';
  $imobiliaria_controle[17]['userdb']    = 'urb201ah';
  $imobiliaria_controle[17]['passdb']    = 'h91Ls22nb8';
  $imobiliaria_controle[17]['basedb']    = 'urbe_tietenegocios_com_br_1';
  ...
  if(@$_SESSION['WEBMASTER'] == 'webmaster'){
    ...
    foreach($imobiliaria_controle as $imob_control){
      // echo $_SERVER['SERVER_NAME']." - www".$imob_control['cliente'];
