...
<?php
    echo "<table>\n";
    echo "<tr><td align=center colspan=2><b>Santander/Banespa não tá certo isso ainda</td></tr>\n";
    ...
    //echo "  <option value='N' "; if( $comregistro=='N' ){ echo 'selected'; } echo ">NÃO</option>";
    //echo "</select></td></tr>\n";
    //echo "<tr><td align=right><b>Cod.Transmissão : </b></td><td><input type=text name=codtransmissao size=30 maxlength=30 value=\"$codtransmissao\"></td></tr>\n";
