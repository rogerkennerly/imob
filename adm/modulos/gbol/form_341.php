...
<?php
    echo "<table>\n";
    echo "<tr><td align=center colspan=2><b>Itaú</td></tr>\n";
    ...
    echo "<tr><td align=right><b>Carteira : </b></td><td><input type=text name=carteira size=3  maxlength=3  value=\"$carteira\">175</td></tr>\n";
