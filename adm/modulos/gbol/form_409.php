...
<?php
    echo "<table>\n";
    echo "<tr><td align=center colspan=2><b>Unibanco</td></tr>\n";
    ...
    echo "<tr><td align=right><b>Código Cobrança : </b></td><td><input type=text name=cc       size=7  maxlength=7  value=\"$cc\"      ></td></tr>\n";
    //echo "<tr><td align=right><b>CC              : </b></td><td><input type=text name=cc1      size=7 maxlength=8 value=\"$cc1\"     >Inclir dígito de verificação</td></tr>\n";
    echo "<tr><td align=right><b>Carteira        : </b></td><td><input type=text name=carteira size=3  maxlength=3  value=\"$carteira\"> só tem a 20</td></tr>\n";
...
<script language="JavaScript">
  function check_formaspagto(f){
    ...
    s = trim(f.elements["cc"      ].value); if (s.length != 7) { alert("Código Cobrança deve ter 7 caracteres" ); return false; }
    //s = trim(f.elements["cc1"     ].value); if (s.length != 7) { alert("Conta Corrente deve ter 7 caracteres"     ); return false; }
