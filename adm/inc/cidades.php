<?php
  ...
  if($_POST["op"] == "alterar"){
    ...
    if(isset($nome)){
      ...
      $descricao_log = "Cidade alterada de $nome_antigo para $nome";
      gravalog($_SESSION["sessao_id_user"], 4, 2, $descricao_log, $s);
      
      $msg = sucesso("Cidade Alterada com sucesso!");
    }
  }
  elseif($_POST){
    $nome = $_POST["nome"];
    if(isset($nome)){
      ...
      if(mysql_num_rows($teste)>0){
        $msg = alerta("Cidade $nome já existe!");
      }else{
        $s = "INSERT INTO $tabela (nome) VALUES ('$nome')";
        mysql_query($s);
        $msg = sucesso("Cidade $nome cadastrada com sucesso!");
  ...
  if($_GET["op"] == "excluir"){
    ...
    mysql_query($s);
    $msg = sucesso("Cidade excluida com sucesso!");
    
    $descricao_log = "Cidade excluida - ".$r_nome["nome"];
    gravalog($_SESSION["sessao_id_user"], 4, 3, $descricao_log, $s);
  }
      ...
      <div class="widget-box" style="margin-bottom:50px;">
        ...
        <div class="widget-body">
          <div class="widget-main">
            <form method="POST" action="index.php?pg=cidades" id="form_cadastro">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="center">
              ...
              <a href="index.php?pg=cidades&op=excluir&id_registro=<?php echo $r["id"]; ?>"onclick="return confirm('Deseja excluir o registro?')" style="display:block;float:left;width:2.5rem;">
