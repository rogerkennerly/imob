<?php
  if($_POST){
    ...
    if(mysql_num_rows($q_teste)>0 OR $usuario == ""){
      echo alerta("Corretor já cadastrado ou em branco!");
    }
    else{
      ...
      $descricao_log = "Corretor incluido - $nome ($usuario)";
      gravalog($_SESSION["sessao_id_user"], 10, 1, $descricao_log, $sql_geral);
      
      echo "<script>location.href='index.php?pg=corretores';</script>"; 
    }
  }
?>
        ...
        <div class="imob-50 imob-right imob-border-left imob-padding-20">
          ...
          <br/><br/>
            ...
            <div class="imob-100 imob-left imob-margin-top-20">
              ...
              <legend>
                Permissões:
                <?php echo toltip("Selecione quais operações o corretor poderá fazer"); ?>
              </legend>
