...
$imobiliaria_controle['cliente']   = 'imobiliariaspaco.com.br';
$imobiliaria_controle['diretorio'] = 'imobiliariaespaco';
$imobiliaria_controle['userdb']    = 'imbesp13154';
$imobiliaria_controle['passdb']    = 'dag02Ld2';	
$imobiliaria_controle['basedb']    = 'imobiliariaespaco_com_br_sistimob';
...
$url =  'http://imob.hospedaria.com.br/importadores/imobiliariaspaco.xml';
$url =  'http://imobiliariaspaco.com.br/sitemap.xml';
  ...
  if(!empty($property['fotos']['foto'])){
    ...
    foreach($property['fotos']['foto'] as $photo){
      ...
      curl_setopt($chb, CURLOPT_FAILONERROR,1);
			curl_setopt($curl, CURLOPT_USERAGENT, "User agent: Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.13) Gecko/20080311 Firefox/2.0.0.13");
      // curl_setopt($ch, CURLOPT_FOLLOWLOCATION,1);
