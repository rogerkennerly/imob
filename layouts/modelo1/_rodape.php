		...
		<div class="imob_rodape_opcoes">
			<div class="imob_rodape_opcoes_item">
				<div class="imob_rodape_opcoes_item_tipos">
					<a href="index.php?pg=busca&finalidade=1&ordem=maior&pagina=1" class='btn_padrao cor_botao cor_borda_hover cor_fonte_hover' id="btn_comprar" title="Comprar um imóvel">Comprar</a>
					<a href="index.php?pg=busca&finalidade=2&ordem=maior&pagina=1" class='btn_padrao cor_botao cor_borda_hover cor_fonte_hover' id="btn_alugar" title="Alugar um imóvel">Alugar</a>
				</div>
			</div>
			<div class="imob_rodape_opcoes_item">
				...
				<div class="imob_rodape_opcoes_item_empresa">
					<ul>
						<li><a href="?pg=sobre" title="Link para a página sobre">Sobre a empresa</a></li>
					</ul>
				</div>
			</div>
			<div class="imob_rodape_opcoes_item">
				...
				<div class="imob_rodape_opcoes_item_atendimento">
					<ul>
						<li><a href="?pg=contato" title="Link para a página fale conosco">Fale conosco</a></li>
					</ul>
				</div>
			</div>
			<div class="imob_rodape_opcoes_item">
