...
<?php
$s_super_destaque = mysql_query("SELECT imovel.*, imovel_finalidade.id_finalidade, imovel_finalidade.valor as valor_finalidade FROM imovel, imovel_finalidade WHERE disponivel = 'S' AND excluido = 'N' AND super_destaque = 'S' AND imovel.id = imovel_finalidade.id_imovel");
						...
						<a href="/imovel/<?php echo $super_destaque['id']; ?>/<?php echo $nome_fin; ?>">
							...
							<div class="imob_destaques_grande_imoveis_item_infos">
								...
								<div class="imob_destaques_grande_imoveis_item_infos_preco">
									<?php  
									if($super_destaque['valor_finalidade']){?>
